...
- EVIDENCE (work_items): everything captured losslessly from Slack, browser, apps, clipboard, files, and the GRASP sync (Outlook emails addressed to the owner plus calendar events). Evidence is never deleted. It is the source layer.
